...
export const MOCK_VIDEO_BY_CATEGORY: VideoItemDto[] = [
  {
    id: 'Ox8ZLF6cGM0',
...
export const MOCKUP_FILTER_MOVIES = [
  {
    Id: 243,
    Title: 'Inception',
    Genres: null,
